...
select
    ...
    is_total,
    -- L6W run rates
    to_char(round(last_6w_rev_run_rate), 'FM999,999,999,999,999') as last_6w_rev_run_rate,
    to_char(round(last_6w_units_run_rate), 'FM999,999,999,999,999') as last_6w_units_run_rate,
    to_char(
    ...
    case
        ...
        or last_6w_units_run_rate_yoy = 0 then null
            ...
            round(
                100 * (last_6w_units_run_rate - last_6w_units_run_rate_yoy) / last_6w_units_run_rate_yoy
            ),
            'FM999,999,990'
        ) || '%'
    end as last_6w_units_run_rate_yoy_pct,
    -- Discrete weeks (wk_5 = oldest, wk_0 = last week)
    ...
    case
        ...
        or fcst_units_run_rate_yoy_13w_im = 0 then null
            ...
            round(
                100 * (fcst_units_run_rate_13w_im - fcst_units_run_rate_yoy_13w_im) / fcst_units_run_rate_yoy_13w_im
            ),
            'FM999,999,990'
        ) || '%'
    ...
    case
        ...
        or fcst_units_run_rate_yoy_13w_ae = 0 then null
            ...
            round(
                100 * (fcst_units_run_rate_13w_ae - fcst_units_run_rate_yoy_13w_ae) / fcst_units_run_rate_yoy_13w_ae
            ),
            'FM999,999,990'
        ) || '%'
